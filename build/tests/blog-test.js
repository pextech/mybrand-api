...
describe('Tests for blog endpoints', function () {
  it('Get all blogs ', function (done) {
    // const id = '5fd499e60bef940efcd79eac';
    _chai["default"].request(_server["default"]).get('/blog/').end(function (err, res) {
  ...
  it('delete Blog by id', function (done) {
    var id = '5fdb9f9081c3811c8866ee94';

    _chai["default"].request(_server["default"])["delete"]("/blog/delete/".concat(id)).end(function (err, res) {
  ...
  it('provides error when deleting Blog with incorrect id', function (done) {
    _chai["default"].request(_server["default"]).get('/blog/').end(function (err, res) {
  ...
  it('gives error with wrong Blog id', function (done) {
    _chai["default"].request(_server["default"]).get('/blog/').end(function (err, res) {
      _chai["default"].request(_server["default"]).get("blog/get/".concat(res.body[0]._id));
